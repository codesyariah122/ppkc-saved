<template>
  <div>
    ...
    <mdb-row center class="justify-content-center card__berita-list">
      <mdb-col v-for="(item, index) in lists" md="4" xs="12" sm="12" :key="item.id" class="mb-3">
        <mdb-card>
      ...
      <mdb-col col="12"  xl="4" lg="12" xs="12" sm="12" :class="`${$device.isDesktop ? 'mb-5 mt-5 shadow-none' : 'mb-2'}`">
