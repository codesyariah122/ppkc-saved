      ...
      <mdb-col col="12" sm="5">
        ...
        <ul>
          <li class="list-unstyled">
            <a href="mailto:ppkcaroulus@gmail.com"
              >Email : <span class="grey-text">ppkcaroulus@gmail.com</span>
            </a>
          </li>
          <li class="list-unstyled">
            <a href="tel:021-3101870"
              >Telephone : <span class="grey-text">021-3101870</span>
            </a>
          </li>
          <li class="list-unstyled">
            <a href="fax:021-3101870"
              >Faximile : <span class="grey-text">021-3101870</span>
            </a>
          </li>
          <li class="list-unstyled">
            <a href="tel:021-3904441"
              >Call Center : <span class="grey-text">021-3904441 ext 2437</span>
            </a>
          </li>
          <li class="list-unstyled">
            <a href="whatsapp://tel:628164851356"
              >WhatsApp: <span class="grey-text">0816-4851-356 </span>
            </a>
          </li>
        </ul>
      </mdb-col>
