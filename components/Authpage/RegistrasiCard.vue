	...
	<mdb-card class="card__registrasi">
		<mdb-card-body class="form__auth">
			...
			<form>
				...
				<p class="text-left">Buat akun baru untuk mengakses seluruh layanan dan informasi pelatihan PPKC</p>
				...
				<div class="form-group has-input">
					...
					<input type="text" class="form-control" placeholder="Alamat Event">
				</div>
				<div class="form-group has-input">
				...
				<div class="form-group mt-5">
					<mdb-btn block color="white" size="md" class="text-primary">Daftar</mdb-btn>
				</div>
			</form>
			<!-- Material form login -->
			...
			<mdb-row :class="`${$device.isMobile ? 'justify-content-center black-text form__daftar-link' : 'justify-content-center black-text'}`">
				<mdb-col md="12" xs="12" sm="12" lg="12">
					<h6 :class="`${$device.isMobile ? 'text-center mt-5 mb-5' : 'text-center mt-5 mb-5' }`">Sudah punya Akun ? <nuxt-link to="/auth/login">Masuk Sekarang</nuxt-link></h6>
				</mdb-col>
			</mdb-row>
