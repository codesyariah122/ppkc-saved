									...
									<mdb-container>
										<mdb-row v-if="bank">
											<mdb-col lg="12" xs="12" sm="12" class="col__card-bank">
												<div v-if="bank.id == 1">
													<img src="https://1.bp.blogspot.com/-cnqbyNUAhE8/Xcodaak_3PI/AAAAAAAABJ4/pWOFZNTwReEyBUt6XIjy5Sk_yWrh76ytACLcBGAsYHQ/s1600/Logo%2BBank%2BBCA.png" class="img-fluid">
													<br>
												...
												<div v-else-if="bank.id == 2">
													<img :src="require('~/assets/images/bank/MandiriLogo.svg')" class="img-fluid">
													<br>
													<h6 class="mt-2">Bank {{bank.nama}} </h6>
													<p> a.n : <span class="text-capitalize">{{bank.nama_rek}}</span> </p>
...
<script>
	import MandiriLogo from '@/assets/images/bank/MandiriLogo.svg'
	...
	export default{
		...
		data(){
			return{
				bank_logo: {
					mandiri: MandiriLogo,
					bca: 'https://t-2.tstatic.net/jogja/foto/bank/images/bank-bca.jpg'
				},
				field: {},
				new_message:'',
				status_pembayaran: '',
