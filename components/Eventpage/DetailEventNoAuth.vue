<template>
  <div>
    ...
    <div v-else>
      <mdb-row
        :class="`${$device.isMobile ? 'row justify-content-center' : ''}`"
      >
        <mdb-col
        ...
        <mdb-col lg="6" xs="6" sm="12" class="event__info">
          ...
          <mdb-row col="12">
            <mdb-col md="6" sm="4">
              <h5>Waktu</h5>
              <p>
                {{ $moment(events.kegiatan.tanggal_awal).format("LL") }} -
                {{ $moment(events.kegiatan.tanggal_akhir).format("LL") }}
              </p>
            </mdb-col>
            <mdb-col md="6" sm="4">
              <h5>Nilai SKP</h5>
          ...
          <mdb-row class="mt-3" col="12">
            <mdb-col md="12" xs="12" sm="12" col="12">
              <mdb-btn
                class="btn my__btn-secondary rounded-pill btn-block mb-2"
      ...
      <mdb-row style="margin-top: 64px">
        ...
        <mdb-col col="12" class="mt-2" style="white-space: pre-wrap">
          <p style="font-size: 1em">{{ events.kegiatan.pengumuman }}</p>
        </mdb-col>
      </mdb-row>
    </div>
  </div>
