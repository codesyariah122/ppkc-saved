  ...
  <div>
    ...
    >
      <mdb-navbar-brand>
        <nuxt-link to="/">
          <img
            :src="require('~/assets/images/logo/brand.svg')"
            class="img-fluid"
          />
        </nuxt-link>
      </mdb-navbar-brand>
      <mdb-navbar-toggler>
        <mdb-navbar-nav right style="margin-right: 2rem">
          ...
          <mdb-nav-item v-if="!token.accessToken" waves-fixed>
            <nuxt-link to="/agendapelatihan" tag="li" navLink>
              Agenda Pelatihan
            </nuxt-link>
          </mdb-nav-item>
          ...
          <mdb-nav-item waves-fixed>
            <nuxt-link to="/ppkc/alur-pendaftaran" tag="li" navLink>
        ...
        >
          <mdb-dropdown-toggle tag="a" navLink slot="toggle">
            ...
            <b-avatar
              v-if="
                profiles.photo !=
                'https://api.ppkc-online.com/image-profiles/function File() { [native code]}'
              "
              variant="primary"
              :src="profiles.photo"
            ></b-avatar>
            ...
            <mdb-dropdown-item>
              ...
              >
                ...
                <b-avatar
                  ...
                  size="1.7rem"
                ></b-avatar>
                &nbsp; <b style="font-weight: 800">{{ profiles.nama }}</b>
              </nuxt-link>
            </mdb-dropdown-item>
